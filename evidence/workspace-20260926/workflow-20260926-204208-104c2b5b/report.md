...
Elapsed: 103.77 seconds (this invocation only).
...
| --- | --- | --- | --- | --- |
| 01-baseline | passed | 12 / 0 / 0 / 0 | 35.416 | [record](01-baseline/result.json), [log](01-baseline/execution.log) |
| 02-original | execution_failed | 1 / 1 / 0 / 0 | 18.166 | [record](02-original/result.json), [log](02-original/execution.log) |
| 03-original-repeat | execution_failed | 1 / 1 / 0 / 0 | 14.207 | [record](03-original-repeat/result.json), [log](03-original-repeat/execution.log) |
| 04-candidate-reproducer | passed | 1 / 0 / 0 / 0 | 12.078 | [record](04-candidate-reproducer/result.json), [log](04-candidate-reproducer/execution.log) |
| 05-candidate-regression | passed | 12 / 0 / 0 / 0 | 11.234 | [record](05-candidate-regression/result.json), [log](05-candidate-regression/execution.log) |
